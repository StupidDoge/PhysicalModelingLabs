...
public class Task2Lab4 : MonoBehaviour
{
    [SerializeField] private float _height, _speed, _t, _radius, _acceleration;
    ...
    private void Output()
    {
        Debug.Log("Time = " + (int)_time + ", distance = " + _distance + ", coordinates = " + _direction);
    }
}
